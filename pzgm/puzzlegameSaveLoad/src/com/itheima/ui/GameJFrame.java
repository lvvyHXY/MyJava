...
public class GameJFrame extends JFrame implements KeyListener, ActionListener {
    ...
    private void initImage() {
        ...
        //添加背景图片
        JLabel background = new JLabel(new ImageIcon("D:\\Java\\puzzlegame\\image\\background.png"));
    ...
    public void getGameInfo(){
        File f = new File("D:\\Java\\puzzlegame\\save");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == replayItem) {
            ...
            //创建一个管理图片的容器对象JLabel
            JLabel jLabel = new JLabel(new ImageIcon("D:\\Java\\puzzlegame\\image\\about.png"));
            //设置位置和宽高
            ...
            path = "D:\\Java\\puzzlegame\\image\\girl\\girl" + number + "\\";
            //计步器清零
            step = 0;
            //再次打乱二维数组中的数据
            initData();
            ...
            try {
                ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("D:\\Java\\puzzlegame\\save\\save"+index+""));
            ...
            //读取存档
            try {
                ObjectInputStream ois = new ObjectInputStream(new FileInputStream("D:\\Java\\puzzlegame\\save\\save"+index+""));
                gi = (GameInfo) ois.readObject();
                ois.close();
            } catch (IOException ex) {
                throw new RuntimeException(ex);
