...
public class LoginJFrame extends JFrame implements MouseListener {
	...
	*/
    ...
    static{
        allUsers.add(new User("a","123"));
        allUsers.add(new User("b","456"));
    }
...
//登陆，注册按钮和，三个输入框
    ...
    public void initView() {
        ...
        login.setIcon(new ImageIcon("D:\\Java\\DouDiZhu\\image\\login\\登录按钮.png"));
        //去除按钮的边框
        ...
        register.setIcon(new ImageIcon("D:\\Java\\DouDiZhu\\image\\login\\注册按钮.png"));
        //去除按钮的边框
        ...
        //7.添加背景图片
        JLabel background = new JLabel(new ImageIcon("D:\\Java\\DouDiZhu\\image\\login\\background.png"));
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(obj == login){
            ...
            userInput.add(new User(usernameInput,passwordInput));
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == login) {
            login.setIcon(new ImageIcon("D:\\Java\\DouDiZhu\\image\\login\\登录按下.png"));
        } else if (e.getSource() == register) {
            register.setIcon(new ImageIcon("D:\\Java\\DouDiZhu\\image\\login\\注册按下.png"));
        }
    }
